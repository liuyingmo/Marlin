...
#define OFFSET_Z -1.84
  ...
  #define Z_STEPPER_ALIGN_XY { { 50+OFFSET_X,10+OFFSET_Y}, {150+OFFSET_X,10+OFFSET_Y}, {100+OFFSET_X,150+OFFSET_Y} }
  ...
  #define Z_STEPPER_ALIGN_ACC        0.1   // Stop iterating early if the accuracy is better than this
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      2000  // (mm) The length of filament for a complete unload.
