...
#define OFFSET_X -7.66
#define OFFSET_Y 23.8
#define OFFSET_Z 0
...
#define _GAP 40
#define Z_STEPPER_ALIGN_XY {{_GAP,_GAP},{X_BED_SIZE-_GAP,_GAP},{X_BED_SIZE/2,Y_BED_SIZE-_GAP/2}}

  //#define Z_STEPPER_ALIGN_XY {{80,20},{155,155},{10,155}}
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_100X_STEPS_PER_SEC  20  // (steps/s) Encoder rate for 100x speed
#endif
...
// LCD Print Progress options
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_MIN_Z_CHANGE 0.02 // (mm) Minimum Z change before saving power-loss data
