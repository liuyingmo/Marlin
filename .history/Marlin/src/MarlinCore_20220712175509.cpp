...
#define HOME_XX  home_offset.x =__LINE__

HOME_XX;
  SETUP_RUN(settings.first_load());   // Load data from EEPROM if available (or use defaults)                                      // This also updates variables in the planner, elsewhere
