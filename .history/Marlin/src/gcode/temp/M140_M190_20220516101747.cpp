...
void GcodeSuite::M140_M190(const bool isM190) {
  ...
  g_m140_m190.is_m190 =isM190;
  g_m140_m190.target_temp =temp;
  g_m140_m190.no_wait_for_cooling =no_wait_for_cooling;

  task_del(task_start_heating);
  task_get(task_start_heating);
}
