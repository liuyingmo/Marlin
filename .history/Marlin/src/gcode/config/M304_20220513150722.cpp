...
#define REPROT_PID(XXX) SERIAL_ECHOLNPGM("M304 Z",XXX," P", par_config.pid##XXX[0], " I", unscalePID_i(thermalManager.temp_bed.pid.Ki), " D", unscalePID_d(thermalManager.temp_bed.pid.Kd));
