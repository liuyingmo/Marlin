...
void setup() {
  ...
  printf_string("CR %d",PWR->CR);
  printf_string("CSR %d",PWR->CSR);
  printf_string("RCC_FLAG_PINRST: %d",!!__HAL_RCC_GET_FLAG(RCC_FLAG_PINRST));
}
...
void jumpToSystemBoot(void)
{
  ...
  if(__HAL_RCC_GET_FLAG(RCC_FLAG_PINRST)!= RESET||1)
