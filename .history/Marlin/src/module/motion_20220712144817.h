...
inline float base_home_pos(const AxisEnum axis) 
{ 
  static const XYZval<float> base_home_pos_P DEFS_PROGMEM = NUM_AXIS_ARRAY(X_HOME_POS, Y_HOME_POS, Z_HOME_POS, I_HOME_POS, J_HOME_POS, K_HOME_POS, U_HOME_POS, V_HOME_POS, W_HOME_POS); return pgm_read_any(&base_home_pos_P[axis]); 
}
